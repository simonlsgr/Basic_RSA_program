...
class rsa():
    ...
    def encrypt(self, __message_in_number_format_list, key):
    ...
    def decrypt(self, __message_in_number_format_list: list, key: dict) -> list:
        message = __message_in_number_format_list
        message_decrypted = []
    ...
    def generate_key(self, __key_length_lower, __key_length_upper):
